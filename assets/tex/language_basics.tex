...
\begin{nerd}
    Grammar~\ref{gram:jac.g4:129:135} shows  the lines from the formal grammar for Jac that corresponds to the parsing of arithmetic.
    \gramcoderange{jac.g4}{Jac grammar clip relevant to arithmetic}{129}{135}
\end{nerd}
...
\begin{nerd}
    Grammar~\ref{gram:jac.g4:119:127} shows the lines from the formal grammar for Jac that corresponds to the parsing of comparison, logical, and membership operations.
    \gramcoderange{jac.g4}{Jac grammar clip relevant to comparison, logic, and membership}{119}{127}
\end{nerd}
...
\begin{nerd}
    Grammar~\ref{gram:jac.g4:107:115} shows the lines from the formal grammar for Jac that corresponds to the parsing of assignment operations.
    \gramcoderange{jac.g4}{Jac grammar clip relevant to assignment}{107}{115}
\end{nerd}
